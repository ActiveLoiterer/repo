...
public class DatabaseHelper extends SQLiteOpenHelper{
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE resultat (_id INTEGER PRIMARY KEY AUTOINCREMENT, frequence INTEGER, pourcentage INTEGER, date DATE);");
	}
	...
	{
		ContentValues cv = new ContentValues();
		cv.put("frequence", r.getFrequence());
		cv.put("pourcentage", r.getPourcentage());
